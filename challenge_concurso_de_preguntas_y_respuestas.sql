...
(16, 1, 4, 1, '¿Cómo se llama la Reina del Reino Unido?', 'El lago Vostok', 'El lago Tanganica', 'El lago Malawi', 'El lago Baikal', 'El lago Baikal'),
(17, 1, 4, 2, '¿Qué rama de la Biología estudia los animales?', 'Cristóbal Colón', 'Juan Díaz de Solís', 'Francisco Pizarro', 'Diego de Almagro', 'Francisco Pizarro'),
(18, 1, 4, 3, '¿Cuál es el lugar más frío de la tierra?', 'El oro', 'El rodio', 'El iridio', 'El paladio', 'El rodio'),
(19, 1, 4, 4, '¿Cuál es quinto planeta en el sistema solar?', 'Pinocho', 'Dumbo', 'Los Tres Caballeros', 'Blancanieves y los siete enanitos', 'Blancanieves y los siete enanitos'),
